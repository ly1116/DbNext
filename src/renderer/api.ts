...
const browserFallback: DbnestApi = {
  ...
  redisSet: async () => { throw new Error(NOT_DESKTOP); },
  redisDel: async () => { throw new Error(NOT_DESKTOP); },
  redisRename: async () => { throw new Error(NOT_DESKTOP); },
  redisExpire: async () => { throw new Error(NOT_DESKTOP); },
  redisSelectDb: async () => { throw new Error(NOT_DESKTOP); },
  redisDbInfo: async () => { throw new Error(NOT_DESKTOP); },
  runSql: async () => { throw new Error(NOT_DESKTOP); },
  runSqlPaged: async () => { throw new Error(NOT_DESKTOP); },
  listSchemaColumns: async () => { throw new Error(NOT_DESKTOP); },
  listDatabases: async () => { throw new Error(NOT_DESKTOP); },
  createDatabase: async () => { throw new Error(NOT_DESKTOP); },
  dbCreateOptions: async () => { throw new Error(NOT_DESKTOP); },
  listTables: async () => { throw new Error(NOT_DESKTOP); },
  listColumns: async () => { throw new Error(NOT_DESKTOP); },
  addColumn: async () => { throw new Error(NOT_DESKTOP); },
  dropColumn: async () => { throw new Error(NOT_DESKTOP); },
  listIndexes: async () => { throw new Error(NOT_DESKTOP); },
  listForeignKeys: async () => { throw new Error(NOT_DESKTOP); },
  listTriggers: async () => { throw new Error(NOT_DESKTOP); },
  getViewDefinition: async () => { throw new Error(NOT_DESKTOP); },
  getFunctionDefinition: async () => { throw new Error(NOT_DESKTOP); },
  getSequenceInfo: async () => { throw new Error(NOT_DESKTOP); },
  listUsers: async () => { throw new Error(NOT_DESKTOP); },
  getUserPrivileges: async () => { throw new Error(NOT_DESKTOP); },
  ...
  renameScript: async () => { throw new Error(NOT_DESKTOP); },
  revealScript: async () => { throw new Error(NOT_DESKTOP); },
  openScriptsFolder: async () => { throw new Error(NOT_DESKTOP); },
  ...
  listObjectsMeta: async () => { throw new Error(NOT_DESKTOP); },
  dropObject: async () => { throw new Error(NOT_DESKTOP); },
  listPgMeta: async () => { throw new Error(NOT_DESKTOP); },
