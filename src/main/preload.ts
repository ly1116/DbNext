...
const api: DbnestApi = {
  ...
  runSql: (connectionId, sql) => ipcRenderer.invoke(IPC.SQL_RUN, connectionId, sql),
  listDatabases: (connectionId) => ipcRenderer.invoke(IPC.SQL_DATABASES, connectionId),
  createDatabase: (connectionId, name) => ipcRenderer.invoke(IPC.SQL_CREATE_DB, connectionId, name),
